type BrandChannel = { id: string; name: string; platform: string; url: string | null; color: string; avatar?: string; audienceLabel?: string; impressionsLabel?: string; hideViews?: boolean }
...
export const BRAND_CHANNELS: BrandChannel[] = [
  ...
  { id: 'spotify', name: 'Marketing by Design', platform: 'Podcast', url: 'https://open.spotify.com/show/1A2CMXrHEjK4WVLeRzrR0j', color: '#1db954', avatar: '/brand/marketing-by-design.jpg', audienceLabel: 'Followers', impressionsLabel: 'Downloads', hideViews: true },
