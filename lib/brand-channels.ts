type BrandChannel = { id: string; name: string; platform: string; url: string | null; color: string; avatar?: string; audienceLabel?: string; impressionsLabel?: string; hideViews?: boolean; primaryMetric?: 'followers' | 'impressions' | 'views'; primaryLabel?: string; handle?: string }
...
export const BRAND_CHANNELS: BrandChannel[] = [
  ...
  { id: 'x', name: 'MMG Design', platform: 'X', url: 'https://x.com/mmg__design', color: '#111827', avatar: '/brand/headshot.jpg', handle: 'mmg__design' },
  ...
  { id: 'columbus_marketing_jobs', name: 'Columbus Marketing Jobs', platform: 'Newsletter', url: 'https://app.beehiiv.com/', color: '#f59e0b', avatar: '/brand/columbus-marketing-jobs.png', audienceLabel: 'Subscribers' },
  { id: 'site_spotlight', name: 'Site Spotlight', platform: 'Substack', url: 'https://sitespotlight.substack.com/', color: '#52525b', avatar: '/brand/site-spotlight.jpg', audienceLabel: 'Subscribers' },
