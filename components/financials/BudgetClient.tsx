...
function ClientCategoryBadge({ category }: { category: 'website_seo' | 'brand_deal' }) {
  return <Badge tone={category === 'website_seo' ? 'blue' : 'amber'}>{category === 'website_seo' ? 'Website & SEO' : 'Brand Deal'}</Badge>
}
